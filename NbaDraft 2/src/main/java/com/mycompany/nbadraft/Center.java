...
public class Center extends Player {
    ...
    public Center(String playerName, String pts, String totalRebounds, String assists, String blocks, String steals) {
        super(playerName, "C", pts, totalRebounds, assists, blocks, steals);
        this.ptsWeight = 0.30;
        this.trbWeight = 0.10;
        this.astWeight = 0.40;
        this.blkWeight = 0.10;
