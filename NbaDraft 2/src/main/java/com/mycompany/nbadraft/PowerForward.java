...
public class PowerForward extends Player {
    ...
    public PowerForward(String playerName, String pts, String totalRebounds, String assists, String blocks, String steals) {
        super(playerName, "PF", pts, totalRebounds, assists, blocks, steals);
        this.ptsWeight = 0.30;
        this.trbWeight = 0.10;
        this.astWeight = 0.40;
        this.blkWeight = 0.10;
